...
const Admission = () => {
  ...
  const handleClick = () => {
    ...
    if (
      ...
      !val.stu_contact_no ||
      !val.stu_whatsapp_no ||
      !val.parent_contact_no ||
      !val.parent_whatsapp_no ||
      !val.address ||
      !val.dob ||
      !val.qualification ||
      !val.course ||
      ...
      !val.pc_laptop ||
      !val.pc_no ||
      !val.laptop_compulsory ||
      !val.gst ||
      !val.extra_note ||
      !val.reception_note ||
      val.installment_details.some((installment) => !installment.amount || !installment.installment_date)
    ) {

      setError("Failed to add admission data. Please try again.");
      setTimeout(() => setError(""), 5000)
      return;
    }

    const installmentDate = val.installment_details.map((installment) => ({
    ...
    axios.post('http://localhost:5000/addmission/addmissionData', {
      ...
      installment_details: installmentDate
    })
  ...
  return (
    ...
    <div className="admission_sec">
      ...
      <form action="/addmissionData" method="POST" encType="multipart/form-data">
        <Tabs defaultActiveKey="home" activeKey={activeTab} onSelect={(tab: any) => setActiveTab(tab)} id="uncontrolled-tab-example" className="mb-5 mx-4">
                    ...
                    <Row className="personal_details">
                      ...
                      <Col lg="4" md="4" sm="6" className="my-2">
                        <label htmlFor="" className="lable">Image</label>
                          ...
                          <input type="file" name="image" value={val.image}  onChange={handleChange}/>
              ...
              <div className="admission_section">
                <div className="admission_details">
                  ...
                  <div className="addmission_per_details">
                    ...
                    {val.installment_details.map((item: any, index: number) => (
                      <Row className="personal_details">
                        <Col lg="4" md="4" sm="6" className="my-2">
