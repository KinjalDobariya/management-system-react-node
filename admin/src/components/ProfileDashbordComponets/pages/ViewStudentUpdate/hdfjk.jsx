...
function Viewstudentupdate() {
    ...
    const handleUpdate = () => {
        ...
        axios.put(`http://localhost:5000/addmission/student-update/${id}`, {
            surname: val.surname,
    ...
    const handleInstallmentChange = (e, index) => {
        ...
        if (name === "amount" || name === "installment_date" || name === "status") {
            setVal((prevVal) => {
                    ...
                    <div className="student_under_div">
                        <Row>
                            ...
                            <Col lg="2" md="6" sm="6" className="my-2  text-center m-auto">
                                <div className='student_header_sec'>
                                    {/* <input type="file" name="image" id="" value={val?.image || ''} onChange={handleChange} placeholder="Enter Surname" /> */}
                                </div>
                            </Col>
                        </Row>
